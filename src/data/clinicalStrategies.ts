...
export const CLINICAL_STRATEGIES: ClinicalStrategyEntry[] = [
  ...
  },
  {
    ...
    definition:
      "Medication or intervention administered during an active disease episode to stop or shorten the attack — distinct from prophylactic (preventive) therapy given chronically to reduce future attack frequency.",
    details: [
      "Migraine abortive: NSAIDs (ibuprofen, naproxen), acetaminophen, triptans (sumatriptan), antiemetics (metoclopramide, ondansetron); early treatment improves efficacy",
      "Cluster headache abortive: 100% oxygen (12–15 L/min non-rebreather) or sumatriptan subcutaneous at attack onset",
      "Triptans are serotonin 5-HT1B/1D agonists — cause cranial vasoconstriction and ↓ trigeminal neuropeptide (CGRP) release",
      "Contraindications for triptans: CAD, uncontrolled hypertension, hemiplegic/basilar migraine, recent stroke/TIA",
      "Prophylaxis indicated when attacks are frequent/disabling despite adequate abortive therapy",
      "Abortive therapy does not replace trigger avoidance, hydration, and sleep regularity",
    ],
    boardsPearls: [
      "Abortive = stop acute attack; prophylactic = prevent future attacks",
      "Migraine abortive: triptans, NSAIDs, antiemetics — not daily β-blockers (those are prophylaxis)",
      "Do not use triptans for migraine prophylaxis — rebound headache risk and wrong indication",
      "Cluster abortive: O₂ or sumatriptan SC; verapamil is prophylaxis not abortive",
      "Early abortive treatment at migraine aura or headache onset improves response",
      "vs abortifacient — drug inducing abortion (mifepristone/misoprostol); unrelated meaning",
      "CGRP antagonists (gepants, monoclonal antibodies) — newer abortive/prophylactic migraine agents (more Step 2 detail)",
    ],
    pediatrics:
      "Pediatric migraine abortive therapy: weight-based ibuprofen or acetaminophen first-line; triptans when NSAIDs fail in adolescents. Cluster headache is rare in children; same abortive principles apply if diagnosed.",
  },
  {
  ...
  },
  {
    ...
    aliases: [
      ...
      "pubertal physical changes",
      "sexual maturity characteristics",
      "development of secondary sexual characteristics",
      "secondary sexual development",
      "pubertal sexual development",
    ],
    definition:
      "Physical features that distinguish males and females and develop at puberty from rising estrogen (females) and testosterone (males) — not present as mature traits at birth — used clinically to stage puberty (Tanner), diagnose precocious or delayed puberty, and assess endocrine disorders.",
    details: [
      "Female secondary sexual characteristics — breast development (thelarche), pubic and axillary hair (pubarche), widening hips, menarche",
      "Male secondary sexual characteristics — testicular enlargement then penile growth, pubic/axillary/facial hair, voice deepening, increased muscle mass and shoulder breadth",
      "Driven by hypothalamic GnRH → pituitary LH/FSH → gonadal sex steroids (estradiol, testosterone)",
      "Adrenarche contributes early pubic/axillary hair via adrenal androgens (DHEA-S) before full gonadarche",
      "Primary sexual characteristics = gonads (ovaries, testes) and internal reproductive ducts — present from embryonic development",
      "Assessed by physical exam and Tanner staging — breast/genital and pubic hair scales scored separately",
      "Absent or delayed secondary sexual characteristics → hypogonadism, constitutional delay, chronic illness, hypergonadotropic failure (Turner, Klinefelter)",
      "Premature development → central precocious puberty (GnRH-dependent), peripheral precocious puberty (autonomous estrogen/androgen), exogenous hormones",
    ],
    boardsPearls: [
      "Secondary sexual characteristics = pubertal sex-steroid–driven traits (breasts, pubic hair, testicular enlargement, voice change)",
      "vs primary sexual characteristics — gonads and internal genitalia from embryology",
      "Girls — thelarche first; boys — testicular enlargement >4 mL first (not penile growth)",
      "No secondary sexual characteristics by 13 (girls) or 14 (boys) → delayed puberty workup",
      "Secondary sexual characteristics before 8 (girls) or 9 (boys) → precocious puberty",
      "Turner syndrome — streak gonads → absent breast development without estrogen replacement",
      "Androgen insensitivity syndrome (46,XY) — female external secondary characteristics without internal female reproductive organs",
      "5α-reductase deficiency — limited virilization until puberty testosterone surge",
    ],
    pediatrics:
      "Document Tanner breast/genital and pubic hair stages at every adolescent preventive visit. Delayed puberty warrants bone age, LH/FSH, testosterone or estradiol, and karyotype when indicated. Isolated premature thelarche may be benign; rapid progression with bone age advancement needs full precocious puberty evaluation.",
  },
  {
    id: "neonate",
    name: "Neonate",
  ...
  },
  {
    ...
    definition:
      "Clinical grading of deep tendon reflexes elicited by percussing a tendon with a reflex hammer — quantifies reflex excitability and helps localize upper vs lower motor neuron lesions.",
    details: [
    ...
    boardsPearls: [
      ...
      "vs stretch reflex — physiologic reflex arc mechanism; this entry is clinical DTR grading scale",
    ],
    pediatrics:
  ...
  },
  {
    ...
    name: "Extubated",
    etymology:
      "Latin ex = out + tubus = pipe — endotracheal tube removed; patient breathing spontaneously through native upper airway",
    aliases: [
      "extubated",
      "extubated patient",
      "post-extubation",
      ...
      "spontaneously breathing after extubation",
      "breathing spontaneously post extubation",
    ],
    definition:
      "Clinical state after removal of the endotracheal tube — patient relies on spontaneous ventilation through the upper airway; may still require supplemental oxygen, close monitoring for post-extubation respiratory failure, and airway protection assessment before oral intake.",
    details: [
      "Follows successful spontaneous breathing trial (SBT) in most ICU weaning protocols",
      "Requires adequate mental status, cough strength, oxygenation, and hemodynamic stability for safe extubation",
      "Post-extubation monitoring for stridor, tachypnea, hypoxemia, and hypercapnia",
      "Laryngeal edema and subglottic narrowing — common cause of post-extubation stridor especially after prolonged intubation",
      "Oral intake resumes only after confirming intact swallow and airway protection",
      "Reintubation required if post-extubation respiratory failure — aspiration, atelectasis, weak respiratory muscles",
      "Noninvasive ventilation (BiPAP) may bridge high-risk patients immediately post-extubation",
    ],
    boardsPearls: [
      "Extubated = ETT out; patient breathing spontaneously — not the same as tracheostomy",
      "vs intubated — invasive airway with mechanical ventilation; extubated has no tracheal tube",
      "Pass SBT (RSBI <105, adequate Vₜ, stable vitals) before extubation in boards vignettes",
      "Post-extubation stridor — inspiratory wheeze after tube removal; racemic epinephrine, steroids; reintubate if severe",
      "GCS and gag/cough reflexes matter — do not extubate if cannot protect airway (unless palliative plan)",
      "High-risk extubation failure — weak neuromuscular disease, prolonged ventilation, difficult airway",
      "Caffeine citrate in neonates reduces extubation failure in apnea of prematurity",
    ],
    pediatrics:
      "Pediatric post-extubation stridor from subglottic edema is common after prolonged intubation — nebulized epinephrine and steroids. Neonates may need gradual ventilator wean rather than adult-style SBT. Apnea of prematurity causes extubation failure in VLBW infants.",
  },
  {
    id: "pregnancy",
    name: "Pregnancy",
  ...
  },
  {
    ...
    name: "Prenatal Care",
    etymology:
      "Latin prae = before + natalis = of birth + Latin cura = care — scheduled obstetric surveillance and preventive interventions during pregnancy to optimize maternal and fetal health",
    aliases: [
      "prenatal care",
      "antenatal care",
    ...
    definition:
      "Routine medical supervision during pregnancy — history, physical exams, laboratory screening, ultrasound surveillance, immunizations, and counseling — aimed at detecting complications early, preventing birth defects, and guiding safe delivery timing and mode.",
    details: [
      "All patients — folic acid 400–800 µg daily starting before conception (4 mg/day if prior neural tube defect pregnancy)",
      "Initial visit — confirm gestational age (LMP or early ultrasound), blood type/Rh, antibody screen, CBC, rubella/varicella immunity, STI screen (HIV, syphilis, gonorrhea/chlamydia per guidelines), urinalysis, hepatitis B",
      "First trimester — dating ultrasound; discuss teratogen avoidance (ACE-I/ARB, isotretinoin, valproate, warfarin, methotrexate, live vaccines)",
      "Second trimester — anatomy ultrasound (~18–20 weeks); maternal serum AFP or quad screen (optional) for NTD and aneuploidy risk; glucose challenge test at 24–28 weeks for gestational diabetes",
      "Rh-negative mother — Rh immunoglobulin (RhoGAM) at ~28 weeks and within 72 hours of delivery if infant Rh-positive; also after bleeding or invasive procedures",
      "Third trimester — group B Streptococcus rectovaginal culture at 35–37 weeks; intrapartum penicillin/ampicillin if GBS-positive; fetal movement assessment; blood pressure surveillance for preeclampsia",
      "High-risk pregnancies — earlier/more frequent ultrasound, nonstress tests, Doppler studies for growth restriction or placental insufficiency",
      "Tdap vaccination in each pregnancy (preferably 27–36 weeks) to protect neonate from pertussis",
    ],
    boardsPearls: [
      "Prenatal folic acid ↓ neural tube defects — start before conception when possible",
      "Quad screen — AFP, hCG, estriol, inhibin A; ↓ AFP suggests Down syndrome or dates error; ↑ AFP suggests NTD or abdominal wall defect",
      "Anatomy scan ~18–20 weeks — detects many structural anomalies",
      "GBS culture 35–37 weeks → intrapartum penicillin prevents neonatal GBS sepsis",
      "Rh-negative unsensitized mother → RhoGAM prophylaxis",
      "Gestational diabetes screen 24–28 weeks — 1-hour glucose challenge",
      "ACE inhibitors/ARBs contraindicated — fetal renal agenesis/oligohydramnios",
      "vs labor management — prenatal care is antepartum surveillance; see stage of labor for intrapartum",
    ],
    pediatrics:
      "Prenatal care directly affects neonatal outcomes — folate prevents NTDs; GBS prophylaxis prevents early-onset neonatal sepsis; Rh prophylaxis prevents hemolytic disease of the newborn. TORCH screening and vaccination status influence congenital infection risk.",
  },
  {
    id: "synergism",
    name: "Synergism",
  ...
  },
  {
    ...
    definition:
      "Dietary pattern that excludes meat (and often fish/poultry) while varying in inclusion of eggs, dairy, and other animal products — clinically relevant on Step 1 chiefly for nutritional deficiency risk (especially vitamin B12 in strict patterns) and as a risk factor vignette clue, not as a disease itself.",
    details: [
      "Lacto-ovo vegetarian — excludes meat/fish but includes eggs and dairy; lower B12 risk if dairy intake adequate",
      "Vegan (strict vegetarian) — no animal products; B12 found only in fortified foods or supplements → deficiency risk",
      "Iron — plant non-heme iron less bioavailable than heme iron; combine with vitamin C to enhance absorption",
      "Vitamin B12 deficiency — megaloblastic anemia, subacute combined degeneration (dorsal columns + lateral corticospinal tracts)",
      "Vitamin D and calcium — monitor bone health especially if dairy also excluded",
      "Pernicious anemia — autoimmune intrinsic factor loss; distinct mechanism from dietary B12 absence",
      "Pregnancy/lactation — increased micronutrient needs; B12, iron, folate supplementation often required in vegan patients",
    ],
    boardsPearls: [
      "Strict vegan diet → vitamin B12 deficiency — megaloblastic anemia, ↑ methylmalonic acid, neurologic signs",
      "Vegetarian vignette clue — think B12, iron deficiency; not pernicious anemia unless autoimmune context",
      "Breastfed infant of unsupplemented vegan mother → B12 deficiency, developmental delay",
      "vs pernicious anemia — anti-intrinsic factor antibodies; spleen/stomach disease mechanism",
      "vs celiac disease — malabsorption of multiple nutrients; anti-tTG, duodenal biopsy",
      "B12 supplementation prevents deficiency — vegan diet is manageable with fortification/supplements",
      "Lacto-ovo vegetarian — eggs/dairy provide B12 if consumed in adequate amounts",
    ],
    pediatrics:
      "Breastfed infants of vegan mothers without B12 supplementation develop megaloblastic anemia, irritability, and developmental delay. Children on plant-based diets need monitored B12, iron, vitamin D, and adequate protein/calories for growth. Maternal B12 deficiency in pregnancy increases neural tube defect risk — supplement preconception.",
  },
  {
  ...
  },
  {
    ...
    etymology:
      "Latin casus = occurrence/fall + Latin control = comparison group — observational design comparing prior exposures in individuals with disease (cases) vs without disease (controls)",
    aliases: [
      "case-control study",
      "case control study",
    ...
    definition:
      "Observational analytic study that identifies individuals with the outcome (cases) and without the outcome (controls), then looks backward to compare the frequency of prior exposures — efficient for studying rare diseases but cannot directly measure incidence.",
    details: [
      "Study direction: outcome → exposure (retrospective)",
      "Cases = have disease; controls = do not have disease (matched or population-based)",
      "Primary measure of association: odds ratio (OR), not relative risk",
      "OR approximates RR when disease is rare",
      "Advantages: fast, inexpensive, good for rare outcomes and multiple exposures",
      "Disadvantages: recall bias, selection bias, cannot calculate incidence or prevalence of disease",
      "Classic example: Doll and Hill smoking and lung cancer; DES and clear cell adenocarcinoma",
    ],
    boardsPearls: [
      "Case-control = start with disease, look back at exposure — retrospective",
      "Use odds ratio (OR), not relative risk",
      "Efficient for rare diseases (e.g., birth defects, specific cancers)",
      "Cannot establish incidence; temporal sequence inferred but not as strong as cohort",
      "Recall bias — cases may remember exposures differently than controls",
      "vs cohort — cohort starts with exposure and follows forward",
      "vs cross-sectional — case-control compares diseased vs non-diseased groups, not single snapshot prevalence",
    ],
    pediatrics:
      "Case-control studies common in pediatric teratology (maternal exposure and birth defects) because outcomes are rare. Newborn screening follow-up studies may use case-control framing for uncommon metabolic diagnoses.",
  },
  {
    id: "case-series-study",
    name: "Case Series Study",
    etymology:
      "Latin casus = occurrence + Latin series = sequence — descriptive report of a group of patients with the same disease or treatment without a comparison control group",
    aliases: [
      "case series study",
      "case series studies",
      "case series",
    ...
    definition:
      "Descriptive observational study reporting outcomes in a series of patients with a particular condition or intervention — no control group, no formal hypothesis testing — lowest level of analytic evidence but useful for rare phenomena and hypothesis generation.",
    details: [
      "No comparison (control) group — cannot measure association or causation",
      "Describes clinical features, treatment, and outcomes in consecutive or selected patients",
      "Useful for rare diseases, new procedures, or adverse effect signals",
      "Cannot control for confounding or calculate relative risk/odds ratio meaningfully",
      "Often published as initial reports before stronger study designs",
      "Example: series of patients with a novel surgical technique or rare syndrome",
    ],
    boardsPearls: [
      "Case series = descriptive only — no control group",
      "Lowest analytic evidence among study types (above expert opinion/case report)",
      "Cannot establish causation or measure relative risk",
      "vs case-control — case series has no comparison group; case-control compares cases to controls",
      "vs cohort — no exposure follow-up; just describes a group with condition",
      "Hypothesis-generating — leads to stronger studies",
    ],
    pediatrics:
      "Pediatric rare disease literature often begins with case series (e.g., novel genetic syndromes). Cannot infer treatment efficacy without controlled comparison — boards may ask to recognize weakest evidence design.",
  },
  {
    id: "crossover-study",
    name: "Crossover Study",
    etymology:
      "cross + over — each participant crosses over from one intervention to another during the trial, serving as their own control",
    aliases: [
      "crossover study",
      "crossover studies",
      "cross-over study",
    ...
    definition:
      "Experimental design in which each subject receives two or more interventions in sequence (often randomized order), with a washout period between — allowing within-subject comparison of treatments and requiring fewer participants than parallel-group trials for equivalent power.",
    details: [
      "Each patient acts as own control — reduces inter-subject variability",
      "Randomized order of treatments (A then B, or B then A)",
      "Washout period between treatments to eliminate carryover effect of first intervention",
      "Best for chronic stable conditions where disease state returns to baseline (e.g., asthma, hypertension, stable angina)",
      "Not suitable for curative treatments, progressive diseases, or interventions with permanent effects",
      "Carryover effect and period effect are key design concerns",
      "Analysis often uses paired comparisons",
    ],
    boardsPearls: [
      "Crossover = each patient gets both treatments in random order",
      "Requires washout period between treatments",
      "Patient serves as own control — fewer subjects needed",
      "Only for chronic stable reversible conditions — not curative surgery or progressive disease",
      "Carryover effect — first treatment affects second period if no washout",
      "vs parallel RCT — parallel groups get one treatment only; crossover gets both sequentially",
      "vs crossover genetic — unrelated; this is trial design",
    ],
    pediatrics:
      "Crossover trials occasionally used in pediatric asthma or ADHD medication comparisons when washout is feasible. Less common in pediatrics due to developmental changes over time and ethical concerns with withholding effective treatment during washout.",
  },
  {
    id: "cross-sectional-study",
    name: "Cross-Sectional Study",
    etymology:
      "Latin cross = transverse + section = cut — single slice in time measuring exposure and outcome simultaneously in a population",
    aliases: [
    ...
    definition:
      "Observational study measuring exposure and disease status at a single point in time (or short interval) in a population — determines prevalence and associations but cannot establish temporal sequence or incidence.",
    details: [
      "Exposure and outcome assessed simultaneously — snapshot of population",
      "Measures prevalence, not incidence",
      "Can compare prevalence of exposure in diseased vs non-diseased at one time point",
      "Fast and inexpensive — surveys, NHANES-style data",
      "Cannot determine whether exposure preceded disease (weak for causality)",
      "Prevalence-incidence bias (Neyman bias) if duration of disease affects who is captured",
      "Example: survey of hepatitis B seroprevalence in a community",
    ],
    boardsPearls: [
      "Cross-sectional = one time point — prevalence study",
      "Cannot establish temporal relationship (exposure before outcome?)",
      "Cannot calculate incidence — only prevalence",
      "Cheap and quick but weak for causation",
      "vs cohort — cohort follows over time for new cases (incidence)",
      "vs case-control — cross-sectional samples whole population snapshot; case-control selects by disease status",
      "Association found may be cause, effect, or confounded — direction unclear",
    ],
    pediatrics:
      "School-based vision or hearing screening surveys are cross-sectional prevalence studies. NHANES pediatric data on obesity or vitamin D prevalence use cross-sectional design — useful for public health planning, not proving causation.",
  },
  {
    id: "prospective-cohort-study",
    name: "Prospective Cohort Study",
    etymology:
      "Latin prospicere = look forward + cohors = enrolled group + study — group free of outcome at baseline followed forward in time for new disease development",
    aliases: [
      "prospective cohort study",
      "prospective cohort studies",
      "prospective study",
      "prospective studies",
      "forward cohort study",
    ...
    definition:
      "Observational analytic study that enrolls individuals based on exposure status (or entire population), follows them forward in time, and compares incidence of outcome between exposed and unexposed groups — establishes temporality and allows calculation of relative risk.",
    details: [
      "Direction: exposure → outcome (forward in time)",
      "Cohort assembled at baseline without outcome (or outcome-free for study question)",
      "Incidence measured in exposed vs unexposed during follow-up",
      "Relative risk (RR) and attributable risk can be calculated",
      "Strongest observational design for causation after RCT",
      "Disadvantages: expensive, lengthy, loss to follow-up, requires large sample for rare outcomes",
      "Examples: Framingham Heart Study, Nurses' Health Study, radiation workers and cancer",
    ],
    boardsPearls: [
      "Prospective cohort = exposure first, follow forward for disease — incidence study",
      "Calculate relative risk (RR) = risk exposed / risk unexposed",
      "Establishes temporality — exposure precedes outcome",
      "vs retrospective cohort — prospective collects data as events occur; retrospective uses past records",
      "vs case-control — cohort measures incidence; case-control uses OR and starts with disease",
      "Loss to follow-up threatens validity",
      "Framingham study — classic prospective cohort vignette",
    ],
    pediatrics:
      "Avon Longitudinal Study and birth cohorts follow children from pregnancy forward for developmental outcomes. Vaccine safety cohorts prospectively track immunized vs unimmunized groups for adverse events incidence.",
  },
  {
    id: "retrospective-cohort-study",
    name: "Retrospective Cohort Study",
    etymology:
      "Latin retrospicere = look back + cohors = enrolled group — cohort defined from historical records and followed through past time to compare outcome incidence by exposure",
    aliases: [
    ...
    definition:
      "Observational cohort study using existing records to identify exposed and unexposed groups in the past and track outcomes that already occurred — faster and cheaper than prospective cohort but subject to record quality and confounding biases.",
    details: [
      "Exposure and outcome both in the past — data extracted from medical records, registries, or occupational databases",
      "Still calculates relative risk if exposure groups defined before outcome occurred historically",
      "Faster and less expensive than prospective cohort",
      "Relies on completeness and accuracy of historical records",
      "Example: workers exposed to asbestos decades ago and lung cancer incidence compared to unexposed workers",
      "Example: infants of diabetic mothers and congenital malformation rates from birth registry data",
      "Confounding and loss to follow-up still apply when records incomplete",
    ],
    boardsPearls: [
      "Retrospective cohort = historical exposure groups, outcome already occurred — still forward logic in time",
      "Can calculate relative risk (unlike case-control)",
      "vs prospective cohort — data already collected; looks back at records",
      "vs case-control — cohort starts with exposure groups; case-control starts with disease",
      "Record bias and missing data common limitations",
      "Temporality preserved if exposure documented before outcome in records",
      "Occupational exposure studies often retrospective cohort design",
    ],
    pediatrics:
      "Retrospective cohort studies use birth registry or EMR data to compare outcomes in exposed vs unexposed pregnancies (e.g., antiepileptic drug exposure and malformations). Faster than prospective enrollment but dependent on chart documentation quality.",
  },
  {
    id: "relative-risk",
    name: "Relative Risk",
    ...
    definition:
      "Epidemiologic measure of association in cohort/prospective studies — the ratio of the probability (or rate) of developing disease in the exposed group divided by that in the unexposed group; RR = 1 suggests no association, RR > 1 increased risk with exposure, RR < 1 protective effect.",
    details: [
      "Formula (2×2 table): RR = [a/(a+b)] / [c/(c+d)] where a = exposed with disease, b = exposed without, c = unexposed with disease, d = unexposed without",
      "Used in cohort and randomized controlled trials with defined exposure and follow-up for incident outcomes",
      "RR = 1 — no association between exposure and outcome",
      "RR > 1 — exposure associated with ↑ disease risk (e.g., smoking and lung cancer)",
      "RR < 1 — exposure associated with ↓ disease risk (protective; e.g., vaccine efficacy when framed as RR < 1 for infection)",
      "Relative risk reduction (RRR) = 1 − RR (often reported in trials; e.g., 25% RRR if RR = 0.75)",
      "Absolute risk reduction (ARR) = risk in control − risk in treatment; needed with NNT = 1/ARR",
      "Cannot calculate RR directly from typical case-control study (no incidence in population at risk) — use odds ratio instead",
      "Confidence interval excluding 1.0 suggests statistically significant association at chosen α",
    ],
    boardsPearls: [
      "Relative risk (RR) = risk in exposed / risk in unexposed — cohort/RCT studies",
      "RR = 1 no association; RR > 1 ↑ risk; RR < 1 protective",
      "vs odds ratio (OR) — case-control studies; OR approximates RR when disease is rare",
      "vs hazard ratio (HR) — time-to-event/survival analysis (Cox model), not simple incidence ratio",
      "RRR = 1 − RR — relative benefit; always pair with ARR and NNT for clinical meaning",
  ...
  },
  {
    ...
    name: "Whipple Triad",
    etymology:
      "eponym: Allen Whipple (surgeon who described hypoglycemia criteria; distinct from Whipple procedure for pancreatic cancer) + Latin trias = group of three",
    aliases: [
      "whipple triad",
      "whipple's triad",
      "whipples triad",
    ...
    definition:
      "Classic diagnostic triad for hypoglycemia from endogenous hyperinsulinism (especially insulinoma): (1) symptoms consistent with hypoglycemia, (2) documented low plasma glucose at the time of symptoms, and (3) relief of symptoms after glucose administration.",
    details: [
      "1. Symptoms — adrenergic (tremor, diaphoresis, palpitations, hunger) and/or neuroglycopenic (confusion, seizures, coma, behavioral change)",
      "2. Low blood glucose — typically <55 mg/dL (≈3 mmol/L) documented during symptomatic episode",
      "3. Symptom resolution with oral or IV glucose — confirms hypoglycemia as cause",
      "During confirmed hypoglycemia: insulinoma shows inappropriately high insulin and C-peptide (endogenous)",
      "Exogenous insulin → high insulin but low C-peptide; sulfonylurea → high insulin and C-peptide on toxicology screen",
      "72-hour supervised fast — provocative test when episodic hypoglycemia suspected",
      "Whipple procedure — pancreaticoduodenectomy for pancreatic cancer; unrelated eponym despite shared name",
    ],
    boardsPearls: [
      "Whipple triad = hypoglycemia symptoms + low glucose + relief with glucose",
      "Classic for insulinoma — fasting hypoglycemia with neuroglycopenic symptoms",
      "During hypoglycemia: ↑ insulin + ↑ C-peptide → endogenous (insulinoma, sulfonylurea)",
      "Exogenous insulin → ↑ insulin, ↓ C-peptide (factitious hypoglycemia)",
      "vs Whipple procedure — surgical resection for pancreatic head cancer; different Whipple",
      "Neuroglycopenic symptoms (confusion, seizure) more specific than adrenergic alone",
      "Weight gain may accompany insulinoma from anabolic effect of excess insulin",
    ],
    pediatrics:
      "True insulinoma is rare in children; congenital hyperinsulinism (KATP channel mutations, nesidioblastosis) causes neonatal/infant hypoglycemia with similar biochemical pattern (↑ insulin during low glucose). Whipple triad logic applies to any hypoglycemia workup in pediatrics.",
  },
  {
  ...
  },
  {
    ...
    definition:
      "Social determinant of health in which individuals lack safe, stable, or affordable housing — including homelessness, frequent moves, overcrowding, or substandard living conditions — increasing risk for infectious disease, chronic illness exacerbation, injury, mental health disorders, and difficulty adhering to medical treatment.",
    details: [
      "Includes literal homelessness, doubling up with family, shelters, and housing cost burden >50% income",
      "Environmental exposures — mold, pests, lead paint, extreme temperatures worsen asthma and infections",
      "Barriers to medication refrigeration, follow-up appointments, and safe storage of supplies (insulin)",
      "Overlaps with food insecurity and transportation barriers — compound health disparities",
      "Associated with ↑ ED utilization, hospital readmission, and delayed preventive care",
      "Clinicians should screen and connect patients to social work and community housing resources when relevant",
    ],
    boardsPearls: [
      "Housing insecurity = social determinant of health (SDOH) affecting outcomes",
      "Asthma exacerbations — mold, cockroaches, overcrowding in unstable housing",
      "Homelessness — ↑ TB, skin infections, frostbite/heat illness, psychiatric comorbidity",
      "Medication nonadherence — cost and unstable living conditions",
      "vs medical diagnosis — housing is contextual risk factor, not disease entity",
      "Lead exposure — older substandard housing in children",
      "Consider SDOH when patient has recurrent ED visits despite appropriate medical therapy",
    ],
    pediatrics:
      "Children in unstable housing have higher rates of asthma, lead poisoning, developmental delay, and school absenteeism. Failure to thrive and recurrent infections warrant inquiry into housing conditions. Homeless youth face trauma, STIs, and substance use risks.",
  },
];
