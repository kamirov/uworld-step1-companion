...
import atrialTachycardia from "../media/images/conditions/atrial-tachycardia.png?url";
import atrioventricularBlock from "../media/images/conditions/atrioventricular-block.png?url";
import avascularNecrosis from "../media/images/conditions/avascular-necrosis.jpg?url";
...
import glaucoma from "../media/images/conditions/glaucoma.png?url";
...
import hypertrophicOsteaoarthropathy from "../media/images/conditions/hypertrophic-osteaoarthropathy.jpg?url";
...
import l5Radiculopathy from "../media/images/conditions/l5-radiculopathy.jpg?url";
...
import paroxysmalSupraventricularTachycardia from "../media/images/conditions/paroxysmal-supraventricular-tachycardia.jpg?url";
...
import piriformisSyndrome from "../media/images/conditions/piriformis-syndrome.png?url";
...
import spasmodicTorticollis from "../media/images/conditions/spasmodic-torticollis.jpg?url";
...
export const CONDITION_IMAGES: Partial<Record<ConditionImageId, string>> = {
  ...
  "hypertrophic-osteaoarthropathy": extensionAssetUrl(hypertrophicOsteaoarthropathy),
  ...
  "piriformis-syndrome": extensionAssetUrl(piriformisSyndrome),
  ...
  "spasmodic-torticollis": extensionAssetUrl(spasmodicTorticollis),
...
> = {
  "21-hydroxylase-deficiency": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:21-hydroxylase-deficiency.png" },
  ...
  "aspiration-pneumonitis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:aspiration-pneumonitis.jpg" },
  ...
  "atrial-tachycardia": { label: "Wikimedia Commons (Multifocal atrial tachycardia - MAT.png)", url: "https://commons.wikimedia.org/wiki/File:Multifocal_atrial_tachycardia_-_MAT.png" },
  ...
  "avascular-necrosis": { label: "Wikimedia Commons (X-ray of idiopathic avascular necrosis of the femoral head - Anteroposterior.jpg)", url: "https://commons.wikimedia.org/wiki/File:X-ray_of_idiopathic_avascular_necrosis_of_the_femoral_head_-_Anteroposterior.jpg" },
  "azoospermia": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:azoospermia.jpg" },
  ...
  "c3-deficiency": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:c3-deficiency.png" },
  ...
  "carcinoid-syndrome": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:carcinoid-syndrome.jpg" },
  ...
  "cluster-headache": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:cluster-headache.svg" },
  ...
  "cushing-disease": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:cushing-disease.jpg" },
  ...
  "ectopic-pregnancy": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:ectopic-pregnancy.png" },
  "ehlers-danlos-syndrome": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:ehlers-danlos-syndrome.jpg" },
  ...
  "femoral-neck-fracture": { label: "Wikimedia Commons (Cdm hip fracture 343.jpg)", url: "https://commons.wikimedia.org/wiki/File:Cdm_hip_fracture_343.jpg" },
  ...
  "gestational-diabetes-mellitus": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:gestational-diabetes-mellitus.jpg" },
  "glaucoma": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:glaucoma.png" },
  ...
  "hypertensive-nephrosclerosis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:hypertensive-nephrosclerosis.jpg" },
  ...
  "hypertrophic-osteaoarthropathy": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:hypertrophic-osteaoarthropathy.jpg" },
  ...
  "juvenile-idiopathic-arthritis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:juvenile-idiopathic-arthritis.png" },
  ...
  "klinefelter-syndrome": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:klinefelter-syndrome.jpg" },
  ...
  "marfan-syndrome": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:marfan-syndrome.jpg" },
  ...
  "minimal-change-disease": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:minimal-change-disease.svg" },
  ...
  "multiple-myeloma": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:multiple-myeloma.png" },
  ...
  "osteogenesis-imperfecta": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:osteogenesis-imperfecta.jpg" },
  ...
  "paroxysmal-supraventricular-tachycardia": { label: "Wikimedia Commons (SVT Lead II-2.JPG)", url: "https://commons.wikimedia.org/wiki/File:SVT_Lead_II-2.JPG" },
  ...
  "pellagra": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:pellagra.jpg" },
  ...
  "precocious-puberty": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:precocious-puberty.jpg" },
  ...
  "scurvy": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:scurvy.jpg" },
  ...
  "spasmodic-torticollis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:spasmodic-torticollis.jpg" },
  ...
  "stauffer-syndrome": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:stauffer-syndrome.jpg" },
  "subarachnoid-hemorrhage": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:subarachnoid-hemorrhage.jpg" },
  "subclavian-steal": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:subclavian-steal.jpg" },
  ...
  "traumatic-brain-injury": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:traumatic-brain-injury.jpg" },
