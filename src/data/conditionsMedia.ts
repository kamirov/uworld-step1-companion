...
> = {
  ...
  "diabetic-nephropathy": { label: "Wikimedia Commons (Diabetic nephropathy.jpg)", url: "https://commons.wikimedia.org/wiki/File:Diabetic_nephropathy.jpg" },
  "diabetic-retinopathy": { label: "Wikimedia Commons (Fundus - diabetic retinopathy.png)", url: "https://commons.wikimedia.org/wiki/File:Fundus_-_diabetic_retinopathy.png" },
  ...
  "asplenic-sepsis": { label: "Wikimedia Commons (Howell-Jolly body.png)", url: "https://commons.wikimedia.org/wiki/File:Howell-Jolly_body.png" },
  ...
  "pheochromocytoma": { label: "Wikimedia Commons (Pheochromocytoma.jpg)", url: "https://commons.wikimedia.org/wiki/File:Pheochromocytoma.jpg" },
  ...
  "primary-hyperparathyroidism": { label: "Wikimedia Commons (Blausen 0533 Parathyroid adenoma.png)", url: "https://commons.wikimedia.org/wiki/File:Blausen_0533_Parathyroid_adenoma.png" },
  ...
  "venous-thrombosis": { label: "Wikimedia Commons (DVTUS.PNG)", url: "https://commons.wikimedia.org/wiki/File:DVTUS.PNG" },
...
> = {
  ...
  "diabetic-nephropathy": "Nodular glomerulosclerosis (Kimmelstiel-Wilson lesion) in diabetic nephropathy",
  ...
  "asplenic-sepsis": "Howell-Jolly body — nuclear remnant in RBC that signals impaired splenic filtration and encapsulated-bacteria risk",
  ...
  "hyperosmolar-hyperglycemic-state": "HHS pattern — extreme hyperglycemia and hyperosmolality with profound dehydration and minimal ketosis",
  ...
  "pheochromocytoma": "Adrenal pheochromocytoma imaging — catecholamine-secreting chromaffin-cell tumor causing episodic hypertension",
  ...
  "primary-hyperparathyroidism": "Parathyroid adenoma schematic — most common cause of primary hyperparathyroidism with high calcium and PTH",
  ...
  "venous-thrombosis": "Ultrasound showing thrombus in the common femoral vein — noncompressible deep vein confirms DVT",
