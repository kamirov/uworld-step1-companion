...
export const PATHOGENESIS: PathogenesisEntry[] = [
  ...
  },
  {
    ...
    definition:
      "Increased red blood cell mass (elevated hematocrit/hemoglobin), classified as primary (intrinsic marrow disorder) or secondary (response to hypoxia, EPO stimulation, or other drivers).",
    examples: [
