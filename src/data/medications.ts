...
export const MEDICATIONS: MedicationEntry[] = [
  ...
  {
    id: "recombinant-erythropoietin",
    name: "Recombinant Erythropoietin",
    etymology: "re- = again + combinare = combine + erythros = red + poiein = to make + -in = protein suffix",
    aliases: [
    ...
    drugClass: "Recombinant erythropoiesis-stimulating agent (ESA)",
    mechanism:
      "Recombinant human erythropoietin binds EPO receptor on erythroid progenitors → JAK2/STAT5 signaling → ↑ red blood cell production and hematocrit.",
    indications: [
      "Anemia of chronic kidney disease",
      "Chemotherapy-associated anemia",
      "Selected perioperative anemia reduction (limited settings)",
    ],
    adverseEffects: [
      "Hypertension and seizures (especially with rapid hematocrit rise)",
      "Thrombosis (arterial and venous) when Hgb overcorrected",
      "Pure red cell aplasia (anti-EPO antibodies — rare)",
      "Headache, flu-like symptoms",
      "Tumor promotion concern if Hgb targets exceeded in cancer",
    ],
    boardsPearls: [
      "Replaces endogenous EPO from renal peritubular interstitial fibroblasts in CKD",
      "Target moderate Hgb — avoid overshooting; ↑ thrombosis and mortality if aggressive",
      "Iron deficiency blunts response — replete iron stores (ferritin, transferrin saturation)",
      "EPO → JAK2 pathway — same axis mutated in polycythemia vera (JAK2 V617F)",
      "vs blood transfusion — ESA avoids alloimmunization but slower and carries hypertension/thrombosis risk",
    ],
  },
  {
    id: "allopurinol",
