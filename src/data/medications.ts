...
export const MEDICATIONS: MedicationEntry[] = [
  ...
  },
  {
    ...
    boardsPearls: [
      ...
      "Potent CYP2D6 inhibitor — ↑ TCA levels, ↓ tamoxifen activation to endoxifen",
  ...
  },
  {
    ...
    mechanism:
      "Rifamycin derivative that acts locally in the GI lumen with minimal systemic absorption → inhibits bacterial RNA polymerase → ↓ ammonia-producing colonic bacteria and other gut flora without significant bloodstream levels.",
    indications: [
      "Hepatic encephalopathy prevention and treatment (with lactulose)",
      "Irritable bowel syndrome with diarrhea (IBS-D)",
      "Traveler's diarrhea (noninvasive E. coli)",
    ],
    adverseEffects: [
      "Generally well tolerated — nausea, abdominal pain, flatulence",
      "Peripheral edema (reported in HE trials)",
      "Low systemic absorption limits traditional antibiotic toxicities",
      "C. difficile risk lower than broad-spectrum systemic antibiotics but not zero",
    ],
    boardsPearls: [
      "Rifaximin — minimal absorption; works in gut lumen",
      "Hepatic encephalopathy — lactulose + rifaximin ↓ ammonia-producing bacteria",
      "vs lactulose — rifaximin is antibiotic; lactulose is osmotic acidifier trapping NH₃",
      "vs neomycin (historical HE) — rifaximin better tolerated, less ototoxicity/nephrotoxicity",
      "IBS-D indication — reduces bloating and diarrhea",
      "Traveler's diarrhea — noninvasive E. coli; not for invasive dysentery (fever/blood)",
      "Does not require dose adjustment for liver disease due to poor absorption",
    ],
  },
  {
    id: "acyclovir",
