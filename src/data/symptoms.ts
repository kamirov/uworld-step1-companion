...
export const SYMPTOMS: SymptomEntry[] = [
  ...
  },
  {
    id: "crackles",
    name: "Crackles",
    etymology: "Middle English crakel = to make a sharp sound; rales (French) = rattling — older synonym",
    aliases: [
      "crackles",
      "crackle",
      "lung crackles",
    ...
    definition:
      "Discontinuous, nonmusical adventitious lung sounds heard predominantly during inspiration — produced by sudden opening of collapsed small airways or movement of air through fluid in alveoli and interstitium.",
    mechanism:
      "Deflation of dependent alveoli (atelectasis, edema, fibrosis) → on inspiration air snaps open collapsed units (fine crackles) or bubbles through secretions/fluid (coarse crackles); gravity localizes crackles to lung bases in cardiogenic edema and many interstitial diseases.",
    thinkOf: [
      "Cardiogenic pulmonary edema — fine bibasilar crackles, orthopnea",
      "Interstitial lung disease (IPF) — fine inspiratory velcro-like crackles",
      "Pneumonia — coarse crackles over consolidation",
    ...
    pairWith: [
      "Fine inspiratory crackles + restrictive PFTs + ↓ DLCO → interstitial lung disease",
      ...
      "Coarse crackles + hemoptysis + chronic sputum → bronchiectasis or TB",
    ],
    distinguishFrom: [
      "Wheezes — continuous high-pitched musical sounds; small-airway bronchospasm (asthma/COPD)",
      "Rhonchi — low-pitched continuous rattling from secretions in larger airways; often clear with cough",
    ...
    pediatrics:
      "Bronchiolitis and asthma in infants more often present with wheeze than crackles. Basilar crackles in an infant with tachypnea may reflect congenital heart disease, pneumonia, or transient tachypnea of the newborn. Cystic fibrosis and interstitial lung disease can cause crackles in older children.",
  },
  {
    id: "rhonchi",
    name: "Rhonchi",
