...
export const SYMPTOMS: SymptomEntry[] = [
  ...
  },
  {
    ...
    definition:
      "Yellow or yellow-green expectorated lower-airway secretion indicating mucopurulent inflammation — most often neutrophil-rich purulent sputum from bacterial lower respiratory tract infection or chronic suppurative lung disease exacerbation.",
    mechanism:
      "Airway bacterial infection or chronic colonization → neutrophil influx and mucus hypersecretion → mucopurulent expectoration; yellow-green color reflects neutrophil myeloperoxidase, degraded cellular debris, and bacterial products — color suggests purulence but does not identify a specific pathogen.",
    thinkOf: [
      ...
      "Bronchiectasis — chronic copious yellow-green sputum with recurrent infections",
      "Cystic fibrosis — thick purulent sputum; Pseudomonas colonization over time",
      "Lung abscess or aspiration pneumonia — foul or purulent expectoration",
    ...
    pairWith: [
      ...
      "Pseudomonas colonization in CF — greenish, often foul purulent sputum",
    ],
    distinguishFrom: [
    ...
    pediatrics:
      "Yellow-green sputum in a child with fever suggests bacterial pneumonia; in infants, also consider chlamydial pneumonia (afebrile, staccato cough, hyperinflation). Chronic purulent yellow sputum from infancy → cystic fibrosis or primary ciliary dyskinesia.",
  },
  {
    id: "mucus",
    name: "Mucus",
