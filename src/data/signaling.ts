...
export const SIGNALING_MOLECULES: SignalingEntry[] = [
  ...
  {
    id: "vascular-endothelial-growth-factor",
    name: "Vascular Endothelial Growth Factor (VEGF)",
    etymology:
      "Latin vas = vessel + endothelium = inner lining + growth + factor — secreted glycoprotein driving angiogenesis and vascular permeability",
    aliases: [
    ...
    type: "Growth factor / cytokine",
    source:
      "Hypoxic tissues (via HIF-1α), tumor cells, macrophages, platelets, and pericytes secrete VEGF; renal clear cell carcinoma overproduces VEGF when VHL tumor suppressor is lost",
    receptor:
      "VEGF receptors VEGFR-1 (Flt-1) and VEGFR-2 (KDR/Flk-1) — receptor tyrosine kinases on endothelial cells; VEGFR-2 is primary mediator of angiogenic signaling",
    function:
      "Potent stimulus for endothelial cell proliferation, migration, and survival — promotes angiogenesis (sprouting of new vessels from existing vasculature) and increases vascular permeability; essential for embryonic vasculogenesis/angiogenesis, wound healing, corpus luteum formation, and pathologic tumor neovascularization.",
    clinicalRelevance: [
      "Solid tumors secrete VEGF — angiogenesis required for tumor growth beyond ~1–2 mm³",
      "Renal cell carcinoma — VHL loss → constitutive HIF → ↑ VEGF (clear cell histology)",
      "Wet (neovascular) age-related macular degeneration — choroidal neovascularization",
      "Proliferative diabetic retinopathy — pathologic retinal neovascularization",
      "Anti-VEGF therapy — bevacizumab (mAb), ranibizumab, aflibercept (VEGF trap) in cancer and retinal disease",
      "VEGF TKIs — sorafenib, sunitinib inhibit VEGFR signaling in RCC and other malignancies",
      "Preeclampsia — altered placental VEGF/PlGF signaling contributes to endothelial dysfunction",
    ],
    boardsPearls: [
      "VEGF = key pro-angiogenic factor; HIF-1α ↑ VEGF transcription in hypoxia",
      "VHL tumor suppressor mutation → HIF stabilization → ↑ VEGF in clear cell RCC",
      "Bevacizumab — anti-VEGF monoclonal antibody for metastatic CRC, RCC, etc.",
      "Intraocular anti-VEGF (ranibizumab) — wet AMD and diabetic macular edema",
      "Tumors need angiogenesis for growth — anti-angiogenic therapy rationale",
      "VEGF increases vascular permeability — protein-rich exudates in inflammation/tumors",
      "vs PDGF — mesenchymal/SMC proliferation; VEGF is endothelial/angiogenesis specialist",
      "vs angiogenesis (process) — VEGF is the mediator, not the process itself",
    ],
    distinguishFrom: [
      "Angiogenesis — physiologic/pathologic process; VEGF is a key driver",
      "PDGF — platelet-derived growth factor; smooth muscle and fibroblast mitogen",
      "FGF — fibroblast growth factor family; broader morphogenesis and repair",
      "Erythropoietin — hematopoietic growth factor, not angiogenic endothelial mitogen",
      "HIF-1α — transcription factor upregulating VEGF in hypoxia, not the growth factor itself",
      "Vasoactive intestinal peptide (VIP) — unrelated neuropeptide despite 'vascular' in name",
    ],
    pediatrics:
      "Retinopathy of prematurity involves dysregulated retinal angiogenesis from relative hyperoxia/hypoxia — distinct from VEGF-driven adult wet AMD but same pathway biology. Infantile hemangiomas show prolific endothelial proliferation in early infancy.",
  },
  {
    id: "gaba",
  ...
  },
  {
    ...
    name: "Endothelin-1",
    etymology:
      "Greek endon = within + thele = nipple (historical vessel term) + -in = peptide suffix — potent vasoconstrictor peptide secreted by vascular endothelial cells",
    aliases: [
      "endothelin 1",
      "endothelin-1",
      "endothelin1",
      ...
      "edn1",
      "endothelin peptide",
      "endothelial vasoconstrictor peptide",
    ],
    type: "Peptide hormone",
    source:
      "Vascular endothelial cells (and other tissues including kidney, heart, lung); preproendothelin cleaved to big endothelin then to active endothelin-1 by endothelin-converting enzyme",
    receptor:
      "Endothelin A (ETA) and endothelin B (ETB) G protein–coupled receptors — ETA on vascular smooth muscle mediates vasoconstriction via Gq → PLC → IP3/DAG → Ca²⁺; ETB on endothelium can release NO/prostacyclin (vasodilation) but smooth muscle ETB also constricts",
    function:
      "Most potent endogenous vasoconstrictor — increases vascular smooth muscle Ca²⁺ and tone; promotes cell proliferation, fibrosis, and inflammation; counterbalances nitric oxide and prostacyclin vasodilator pathways.",
    clinicalRelevance: [
      "↑ endothelin-1 in pulmonary arterial hypertension (PAH) — drives vasoconstriction and vascular remodeling",
      "Endothelin receptor antagonists — bosentan, ambrisentan, macitentan — PAH therapy",
      "Endothelial dysfunction in atherosclerosis, heart failure, and preeclampsia involves dysregulated endothelin/NO balance",
      "ETB receptor mediates clearance of endothelin and can release NO from endothelium",
    ],
    boardsPearls: [
      "Endothelin-1 — potent vasoconstrictor from endothelium; opposes NO",
      "ETA receptor on smooth muscle → Gq → vasoconstriction (same pathway as angiotensin II, α1)",
      "PAH treatment — endothelin receptor antagonists (bosentan, ambrisentan)",
      "vs nitric oxide — NO → cGMP → vasodilation; endothelin → vasoconstriction",
      "ET-1 mnemonic: E = Endothelium makes it; ETA = Arterial smooth muscle constricts",
      "Endothelin-converting enzyme (ECE) activates big endothelin → ET-1",
    ],
    distinguishFrom: [
      "Nitric oxide — endothelium-derived relaxing factor; cGMP vasodilator",
      "Angiotensin II — RAAS vasoconstrictor; AT1 Gq receptor, not endothelin receptor",
      "Norepinephrine — sympathetic neurotransmitter vasoconstrictor",
      "Bradykinin — vasodilator peptide degraded by ACE",
      "Endothelin-2 and endothelin-3 — related isoforms; ET-1 is dominant vascular form",
    ],
    pediatrics:
      "Pediatric PAH (idiopathic or congenital heart disease–associated) uses same endothelin pathway antagonists in specialized centers; neonatal persistent pulmonary hypertension involves pulmonary vasoconstrictor imbalance including endothelin excess relative to NO.",
  },
  {
    id: "estradiol",
    name: "Estradiol",
  ...
  },
  {
    ...
    aliases: ["interferon", "ifn", "type i interferon", "ifn-alpha", "ifn-beta"],
    type: "Cytokine",
  ...
  },
  {
    ...
    etymology:
      "Latin granulum = small grain + Greek kytos = cell + Latin colonia = settlement + Latin stimulare = to goad + Latin factor = causal agent — hematopoietic growth factor (CSF3) that stimulates neutrophil production and release",
    aliases: [
    ...
    type: "Growth factor",
    source:
      "Endothelial cells, fibroblasts, macrophages, monocytes, and stromal cells; induced by IL-17, TNF, and IL-1 during inflammation",
    receptor: "G-CSF receptor (CSF3R) — JAK2-STAT3 and PI3K pathways",
    function:
      "Stimulates proliferation and differentiation of neutrophil progenitors in bone marrow, accelerates neutrophil release from marrow stores, and prolongs neutrophil survival — primary colony-stimulating factor for the neutrophil lineage.",
    mnemonic:
      "G-CSF = Granulocytes Come from Stimulated marrow: neutrophil-specific CSF.",
    clinicalRelevance: [
      "Filgrastim (recombinant G-CSF) and pegfilgrastim — prevent/treat chemotherapy-induced neutropenia",
      "Severe congenital neutropenia and cyclic neutropenia — chronic G-CSF therapy in selected cases",
      "Drug-induced agranulocytosis (e.g., clozapine, antithyroid drugs) — G-CSF may accelerate neutrophil recovery",
      "Stem cell mobilization before autologous hematopoietic transplant",
      "Autoantibodies to G-CSF reported in some autoimmune neutropenia syndromes",
    ],
    boardsPearls: [
      "G-CSF = neutrophil-specific colony-stimulating factor (CSF3)",
      "Filgrastim — recombinant G-CSF for neutropenia after chemotherapy",
      "GM-CSF stimulates granulocytes and macrophages; G-CSF is neutrophil-focused",
      "M-CSF drives macrophage/osteoclast lineage; IL-5 drives eosinophils",
      "IL-17 induces epithelial/stromal G-CSF → neutrophil recruitment at mucosa",
      "vs GM-CSF — G-CSF narrower (neutrophils); GM-CSF broader myeloid stimulation",
    ],
    distinguishFrom: [
      "GM-CSF — stimulates granulocyte and macrophage progenitors (CSF2; sargramostim)",
      "M-CSF — macrophage/osteoclast lineage (CSF1)",
      "IL-5 — eosinophil growth and activation, not neutrophils",
      "Granulocyte-macrophage colony-stimulating factor — broader myeloid scope than G-CSF",
      "Filgrastim vs filaggrin — homophone trap; filaggrin is epidermal barrier protein",
    ],
    pediatrics:
      "Febrile neutropenia in children on chemotherapy requires urgent cultures and empiric antibiotics. Severe congenital neutropenia and cyclic neutropenia may respond to chronic G-CSF; Kostmann syndrome is a classic severe congenital neutropenia.",
  },
  {
    id: "gm-csf",
    name: "GM-CSF",
    etymology: "GM = granulocyte-macrophage + CSF = colony-stimulating factor",
    aliases: ["gm-csf", "gm csf", "granulocyte macrophage colony stimulating factor", "granulocyte-macrophage colony-stimulating factor", "granulocyte macrophage colony stimulator factor", "granulocyte-macrophage colony stimulator factor", "gm colony stimulating factor", "csf2", "sargramostim"],
    type: "Growth factor",
  ...
  },
  {
    ...
    aliases: [
      ...
      "adenosine 3',5'-cyclic monophosphate",
      "adenylate cyclase product",
      "adenylyl cyclase product",
    ],
    type: "Second messenger",
    source:
  ...
  },
  {
    ...
    aliases: [
      ...
      "α2 receptor",
      "alpha 2 adrenergic receptor",
      "aipha-2 adrenoreceptor",
      "aipha 2 adrenoreceptor",
      "alpha-2 adrenoreceptor",
      "alpha 2 adrenoreceptor",
      "α2 adrenoreceptor",
      "aipha-2 adrenergic receptor",
    ],
    type: "Signaling pathway",
    source:
  ...
  {
    id: "beta-1-adrenergic-receptor",
    name: "Beta-1 Adrenergic Receptor",
    etymology:
      "Greek beta = second letter + -ergic = work/active + 1 = subtype + receptor = receiver — Gs-coupled adrenergic receptor mediating cardiac and renal sympathetic effects",
    aliases: [
    ...
    type: "Signaling pathway",
    source:
      "Cardiac sinoatrial and ventricular myocardium, juxtaglomerular cells of kidney (renin release), and adipocytes (lipolysis with some β1 expression)",
    receptor: "Gs-coupled GPCR → activates adenylyl cyclase → ↑ cAMP → PKA phosphorylation of L-type Ca²⁺ channels and phospholamban",
    function:
      "Increases heart rate (chronotropy), contractility (inotropy), and conduction velocity (dromotropy); stimulates renin release from juxtaglomerular apparatus; primary cardiac target of norepinephrine and epinephrine sympathetic signaling.",
    clinicalRelevance: [
      "Metoprolol, atenolol, bisoprolol — β1-selective blockers for hypertension, angina, and heart failure",
      "Propranolol — nonselective β-blocker also blocks β1 (and β2)",
      "Dobutamine — β1-selective inotrope for cardiogenic shock and acute decompensated HF",
      "Epinephrine and norepinephrine activate β1 → ↑ HR and contractility",
      "β-blockers mask hypoglycemia tachycardia in diabetics; abrupt withdrawal → rebound tachycardia/ischemia",
    ],
    boardsPearls: [
      "β1 = Gs → ↑ cAMP → ↑ HR, contractility, renin release",
      "Cardioselective β1 blockers — metoprolol, atenolol (still use cautiously in asthma)",
      "vs β2 — β2 bronchial/uterine; β1 cardiac dominant",
      "Dobutamine — β1 inotrope (↑ contractility) for acute HF/shock",
      "Juxtaglomerular β1 — sympathetic tone stimulates renin (RAAS)",
      "Nonselective β-blocker (propranolol) blocks β1 and β2",
    ],
    distinguishFrom: [
      "Beta-2 adrenergic receptor — bronchial and uterine Gs effects",
      "Alpha-1 adrenergic receptor — Gq vasoconstriction",
      "Muscarinic M2 receptor — Gi ↓ HR via parasympathetic ACh, not adrenergic",
      "Dopamine D1 receptor — renal vasodilation at low dopamine doses",
    ],
    pediatrics:
      "β-blockers rarely first-line in pediatric hypertension but used for arrhythmias and HOCM; asthma history favors β1-selective agents. Congenital long QT and catecholaminergic polymorphic VT may require β-blockade.",
  },
  {
  ...
  {
    id: "muscarinic-cholinergic-receptors",
    name: "Muscarinic Cholinergic Receptor",
    etymology:
      "Latin musca = fly (muscarine from Amanita muscaria) + Greek chole = bile + -ergic = work — G protein–coupled acetylcholine receptors (M1–M5) on postganglionic parasympathetic effectors and selected CNS neurons",
    aliases: [
    ...
    type: "Signaling pathway",
    source:
      "Postganglionic parasympathetic target organs (heart SA/AV node M2, smooth muscle and glands M3, CNS M1/M4/M5) and sweat glands (sympathetic cholinergic M3)",
    receptor:
      "GPCR family — M1/M3/M5 couple to Gq (IP3/Ca²⁺); M2/M4 couple to Gi (↓ cAMP); activated by acetylcholine from postganglionic parasympathetic fibers",
    function:
      "Mediate 'rest and digest' parasympathetic effects — ↓ heart rate (M2), bronchoconstriction and ↑ secretions (M3), GI motility, miosis, bladder contraction, and CNS cognition (M1); opposed by antimuscarinic drugs (atropine).",
    clinicalRelevance: [
      "Atropine/scopolamine — nonselective muscarinic antagonists (mydriasis, ↓ secretions, tachycardia, ileus, urinary retention)",
      "Ipratropium/tiotropium — inhaled M3 antagonists for COPD/asthma",
      "Oxybutynin — M3 antagonist for overactive bladder",
      "Organophosphate poisoning — excess ACh → muscarinic SLUDGE + nicotinic effects",
      "Donepezil — AChE inhibitor enhances muscarinic signaling in Alzheimer disease",
    ],
    boardsPearls: [
      "Muscarinic = GPCR; nicotinic = ion channel — both activated by ACh",
      "M1/M3/M5 = Gq → contraction/secretion; M2/M4 = Gi → ↓ HR",
      "SLUDGE from muscarinic overstimulation: Salivation, Lacrimation, Urination, Defecation, GI upset, Emesis",
      "Atropine blocks muscarinic — not nicotinic NMJ paralysis",
      "Sweat glands — sympathetic but muscarinic (ACh) innervation",
      "vs β2 adrenergic — epinephrine bronchodilation is β2, not muscarinic",
    ],
    distinguishFrom: [
      "Nicotinic cholinergic receptors — ligand-gated ion channels at NMJ and autonomic ganglia",
      "Acetylcholine — neurotransmitter ligand for both muscarinic and nicotinic receptors",
      "Muscarinic M1 receptor — specific CNS/parietal Gq subtype",
      "Muscarinic M3 receptor — specific peripheral smooth muscle/gland Gq subtype",
      "Beta-2 adrenergic receptor — catecholamine bronchodilation, not cholinergic",
    ],
    pediatrics:
      "Atropine overdose in children causes anticholinergic toxidrome with hyperthermia and delirium. Ipratropium safe in pediatric asthma/COPD. Muscarinic biology identical; dosing weight-based.",
  },
  {
  ...
  },
  {
    ...
    aliases: [
      ...
      "alpha 1 adrenoreceptor",
      "α1 adrenoreceptor",
      "aipha-1 adrenoreceptor",
      "aipha-1 adrenergic receptor",
    ],
    type: "Signaling pathway",
    source:
  ...
  },
  {
    ...
    etymology:
      "Gamma-aminobutyric acid + B = second GABA receptor class + receptor = receiver — metabotropic Gi/o-coupled inhibitory receptor",
    aliases: [
      "gaba-b receptor",
      "gaba-b",
      "gabab",
      ...
      "type b gaba receptor",
    ],
    type: "Signaling pathway",
    source:
      "Presynaptic and postsynaptic membranes at GABAergic synapses — especially spinal cord, thalamus, and cortex; requires GABA-B1/GABA-B2 heterodimer for functional Gi/o coupling",
    receptor:
      "Metabotropic GPCR heterodimer (GABA-B1 + GABA-B2) coupled to Gi/o proteins — not an ion channel; GABA binding → Gi/o activation → ↓ adenylyl cyclase/cAMP, opens GIRK K⁺ channels, inhibits voltage-gated Ca²⁺ channels",
    function:
      "Mediates slow, prolonged inhibitory neurotransmission — presynaptic GABA-B activation ↓ Ca²⁺ influx and neurotransmitter release; postsynaptic GABA-B activation hyperpolarizes via K⁺ efflux; balances excitability in spinal motor pathways and corticothalamic circuits.",
    clinicalRelevance: [
      "Baclofen — selective GABA-B receptor agonist for spasticity (MS, spinal cord injury)",
      "Intrathecal baclofen pump for severe spasticity",
      "Baclofen withdrawal — seizures, autonomic instability if stopped abruptly",
      "vs benzodiazepines — benzos modulate GABA-A ionotropic receptors, not GABA-B",
      "GHB (γ-hydroxybutyrate) — acts at GABA-B receptors (abuse/toxicity)",
    ],
    boardsPearls: [
      "GABA-B = metabotropic Gi/o-coupled receptor heterodimer (GABA-B1/GABA-B2)",
      "Baclofen = GABA-B agonist → ↓ spasticity at spinal level",
      "GABA-A vs GABA-B: GABA-A is ionotropic Cl⁻ channel (benzos); GABA-B is slow Gi inhibition",
      "Presynaptic GABA-B ↓ Ca²⁺ → ↓ neurotransmitter release; postsynaptic GABA-B opens K⁺ channels",
      "vs gabapentin — binds α2δ Ca²⁺ channel subunit, NOT GABA-B receptor",
      "vs glycine receptor — separate inhibitory Cl⁻ channel in spinal cord",
      "Abrupt baclofen cessation → withdrawal seizures",
    ],
    distinguishFrom: [
      "GABA-A receptor — ionotropic pentameric Cl⁻ channel; benzodiazepine and barbiturate target",
      "GABA — neurotransmitter ligand, not the receptor",
      "Glycine receptor — inhibitory Cl⁻ channel in spinal cord; glycine is ligand",
      "Gabapentin/pregabalin — α2δ ligands; do not bind GABA receptors",
      "Glutamate receptors — excitatory (NMDA, AMPA), opposite primary role",
      "Muscarinic acetylcholine receptor — different Gi-coupled GPCR, not GABAergic",
    ],
    pediatrics:
      "Intrathecal baclofen used in children with severe cerebral palsy spasticity; GABA-B signaling is part of normal spinal inhibitory tone. Baclofen withdrawal is dangerous at any age.",
  },
  {
    id: "nmda-receptor",
    name: "NMDA Receptor",
  ...
  },
  {
    ...
    etymology:
      "Greek delta (δ) = fourth letter + opioid + receptor = receiver — DOR-class Gi-coupled GPCR modulating analgesia, mood, and autonomic tone; enkephalins are primary endogenous ligands",
    aliases: [
    ...
    type: "Signaling pathway",
    source:
      "CNS — olfactory bulb, cortex, limbic structures, spinal cord dorsal horn, and peripheral sensory neurons; Gi/Go-coupled GPCR co-expressed with μ and κ receptors",
    receptor:
      "Gi/Go-coupled GPCR → ↓ adenylyl cyclase → ↓ cAMP → ↓ neurotransmitter release; opens K⁺ channels and closes voltage-gated Ca²⁺ channels → neuronal hyperpolarization",
    function:
      "Modulates nociception (especially chronic and inflammatory pain), emotional/affective processing, and stress responses; enkephalins (Met-enkephalin, Leu-enkephalin) are primary endogenous agonists; contributes to opioid analgesia and mood effects alongside μ receptors.",
    clinicalRelevance: [
      "Enkephalins — endogenous δ (and μ) opioid peptide agonists derived from proenkephalin",
      "Exogenous opioids (morphine, fentanyl) have variable δ activity but μ agonism dominates clinical analgesia",
      "δ agonism explored for antidepressant and anxiolytic effects without full μ respiratory depression (research context)",
      "Naloxone/naltrexone — nonselective opioid antagonists block δ along with μ and κ",
      "Analgesic synergy — combined μ and δ activation may enhance pain relief in some models",
    ],
    boardsPearls: [
      "δ receptor — enkephalin-preferring opioid GPCR; modulatory analgesia and mood",
      "Gi-coupled like μ and κ — ↓ cAMP, hyperpolarization, ↓ pain transmission",
      "vs μ receptor — μ mediates primary morphine analgesia, respiratory depression, and euphoria",
      "vs κ receptor — κ more dysphoria/diuresis; δ more mood and enkephalin-linked modulation",
      "Endogenous enkephalins — δ and μ ligands from proenkephalin",
      "Naloxone blocks classical opioid GPCRs including δ — not primary target in overdose (μ-driven resp depression)",
    ],
    distinguishFrom: [
      "Mu opioid receptor — primary morphine analgesia, respiratory depression, and euphoria",
      "Kappa opioid receptor — dysphoria, spinal analgesia, diuresis; dynorphin-preferring",
      "Sigma receptor — atypical binding site; not a classical opioid GPCR; naloxone-insensitive",
      "Enkephalin — endogenous peptide ligand, not the receptor",
      "NMDA receptor — glutamate ion channel; ketamine antagonist",
      "GABA-A receptor — chloride channel; benzodiazepine target",
    ],
    pediatrics:
      "δ-opioid biology is present from fetal development; clinical opioid toxicity in children still reflects predominantly μ-receptor agonism (respiratory depression, miosis). Enkephalinergic tone participates in stress and pain modulation in neonates.",
  },
  {
    id: "sigma-opioid-receptor",
    name: "Sigma Receptor",
    etymology:
      "Greek sigma (σ) = summation sign + receptor = receiver — originally classified as opioid receptor type 3; now recognized as distinct non-opioid binding sites (σ1 and σ2) not coupled to classic Gi opioid GPCR signaling",
    aliases: [
      "sigma receptor",
      "σ receptor",
      "σ",
      ...
      "sigma 2 receptor",
      "σ2 receptor",
      "opioid sigma receptor",
      "opioid σ receptor",
    ],
    type: "Signaling pathway",
    source:
      "σ1 — endoplasmic reticulum/mitochondria-associated chaperone-regulated binding site (SIGMAR1); σ2 — distinct transmembrane protein; expressed in CNS, immune cells, and peripheral tissues — not a Gi-coupled opioid GPCR",
    receptor:
      "Atypical ligand-regulated binding sites — modulate Ca²⁺ signaling, ion channel function, and neurotransmitter release; structurally and pharmacologically distinct from μ, δ, and κ opioid GPCRs",
    function:
      "Modulates NMDA glutamate signaling, dopamine release, and cellular stress responses; σ1 agonism linked to neuroprotection and psychotomimetic effects at high doses; does not mediate classic opioid analgesia or naloxone-reversible respiratory depression.",
    clinicalRelevance: [
      "Pentazocine — κ-agonist with σ-agonist activity → psychotomimetic/dysphoric effects at higher doses",
      "Haloperidol metabolite and atypical antipsychotics — σ receptor affinity contributes to extrapyramidal and metabolic side-effect profiles",
      "Dextromethorphan — NMDA antagonist with σ1 activity at high doses",
      "Cocaine and methamphetamine — interact with σ receptors (addiction pharmacology)",
      "Naloxone — does not reliably antagonize σ-mediated effects; reverses μ-driven opioid overdose",
      "DTZ (ditolylguanidine) — prototypical σ ligand (research tool)",
    ],
    boardsPearls: [
      "σ receptor — NOT a true classical opioid GPCR despite historical 'opioid receptor' label",
      "μ, δ, κ = Gi-coupled opioid GPCRs; σ = separate atypical site (σ1, σ2)",
      "Pentazocine psychotomimetic effects — κ + σ activity, not pure μ agonism",
      "Naloxone reverses μ-opioid overdose — does not explain σ-mediated psychotomimesis",
      "vs μ receptor — μ mediates morphine analgesia and respiratory depression",
      "vs κ receptor — κ is true opioid GPCR; σ is pharmacologically distinct",
      "σ1 chaperone activity at ER-mitochondria interface — cellular stress modulation",
    ],
    distinguishFrom: [
      "Mu opioid receptor — Gi-coupled GPCR; morphine analgesia; naloxone-reversible overdose",
      "Delta opioid receptor — Gi-coupled enkephalin-preferring opioid GPCR",
      "Kappa opioid receptor — Gi-coupled dynorphin-preferring opioid GPCR; dysphoria",
      "NMDA receptor — ionotropic glutamate receptor; σ modulates but is not NMDA",
      "Naloxone — opioid GPCR antagonist; poor σ antagonist",
      "Pentazocine — mixed κ agonist + σ activity drug, not the receptor itself",
    ],
    pediatrics:
      "Pediatric opioid overdose management targets μ-receptor reversal with naloxone; σ-mediated psychotomimetic effects from mixed agonists (e.g., pentazocine) are not the primary neonatal abstinence or respiratory depression mechanism.",
  },
  {
    id: "aflatoxin",
    name: "Aflatoxin",
  ...
  },
  {
    ...
    etymology:
      "adenosine (from ATP substrate) + -yl + cyclase = ring-forming enzyme — membrane enzyme synthesizing cyclic AMP from ATP",
    aliases: [
      "adenylyl cyclase",
      "adenylate cyclase",
      "adenyl cyclase",
    ...
    type: "Signaling pathway",
    source:
      "Transmembrane enzyme at inner leaflet of plasma membrane — activated by Gαs-GTP and inhibited by Gαi-GTP after GPCR stimulation",
    receptor:
      "Regulated by heterotrimeric G proteins — Gs stimulates, Gi inhibits; also modulated by Ca²⁺/calmodulin and PKC in some isoforms",
    function:
      "Catalyzes conversion of ATP → 3′,5′-cyclic AMP (cAMP) + pyrophosphate — amplifies extracellular GPCR signals into intracellular second messenger that activates protein kinase A (PKA) and other cAMP effectors.",
    clinicalRelevance: [
      "Cholera toxin — ADP-ribosylates Gαs → constitutive adenylyl cyclase activation → secretory diarrhea",
      "Pertussis toxin — inactivates Gi → loss of adenylyl cyclase inhibition → ↑ cAMP",
      "β-adrenergic agonists (albuterol) → Gs → adenylyl cyclase → bronchodilation",
      "Glucagon, PTH, TSH, LH/FSH, CRH, ADH (V2) — Gs-coupled hormones use adenylyl cyclase",
      "McCune-Albright — mosaic Gαs mutations → autonomous adenylyl cyclase/cAMP signaling",
      "Phosphodiesterase inhibitors — block cAMP degradation downstream of adenylyl cyclase",
    ],
    boardsPearls: [
      "Adenylyl cyclase = adenylate cyclase — ATP → cAMP",
      "Gs ↑ adenylyl cyclase; Gi ↓ adenylyl cyclase — same enzyme, opposite regulation",
      "cAMP is the product — see cyclic AMP entry; PKA is main effector",
      "Cholera toxin locks Gαs ON → ↑ adenylyl cyclase → ↑ cAMP → secretory diarrhea",
      "vs guanylyl cyclase — synthesizes cGMP (NO, ANP), not cAMP",
      "vs phospholipase C — cleaves PIP2 to IP3/DAG (Gq pathway), not cAMP",
      "Full cascade: Gs → adenylyl cyclase → cAMP → PKA (camp-pka-pathway entry)",
    ],
    distinguishFrom: [
      "Cyclic AMP (cAMP) — second messenger product, not the synthesizing enzyme",
      "Guanylyl cyclase — produces cGMP from GTP",
      "Phospholipase C — Gq effector cleaving PIP2",
      "Protein kinase A — phosphorylates substrates after cAMP binding",
      "Gs protein — upstream GTPase that activates adenylyl cyclase",
      "Phosphodiesterase — degrades cAMP, does not synthesize it",
    ],
    pediatrics:
      "Cholera causes severe dehydration in infants via Gαs–adenylyl cyclase–cAMP enterocyte secretion. β-agonists for pediatric asthma use same adenylyl cyclase → cAMP → bronchodilation pathway.",
  },
  {
    id: "arachidonic-acid-phospholipase-a2-pathway",
    name: "Arachidonic Acid / Phospholipase A₂ Pathway",
    etymology:
      "Greek arachis = peanut (source of related fatty acid name) + eicosatetraenoic + phospholipid + -ase = cleaving enzyme — PLA₂ releases arachidonic acid from membrane phospholipids for eicosanoid synthesis",
    aliases: [
      "arachidonic acid",
      "phospholipase a2",
      ...
      "eicosanoid precursor pathway",
      "aa pathway",
      "membrane phospholipid to arachidonic acid",
    ],
    type: "Signaling pathway",
    source:
      "Arachidonic acid (20:4 ω-6) esterified in membrane phospholipids (especially phosphatidylcholine, phosphatidylinositol); released by cytosolic or secretory phospholipase A₂ (PLA₂) after Ca²⁺ rise or receptor activation",
    receptor:
      "PLA₂ activated by ↑ cytosolic Ca²⁺, phosphorylation, and inflammatory stimuli; free arachidonic acid acts as substrate for cyclooxygenase (COX) and lipoxygenase (LOX) enzymes",
    function:
      "PLA₂ hydrolyzes sn-2 ester bond of membrane phospholipids → releases arachidonic acid → COX pathway produces prostaglandins and thromboxane; LOX pathway produces leukotrienes; mediates inflammation, pain, fever, bronchoconstriction, platelet aggregation, and gastric protection.",
    clinicalRelevance: [
      "NSAIDs inhibit COX → ↓ prostaglandin synthesis from arachidonic acid → analgesia, antipyresis, GI ulcer risk",
      "Aspirin irreversibly acetylates COX-1/COX-2 — antiplatelet via ↓ thromboxane A₂",
      "Zileuton inhibits 5-lipoxygenase → ↓ leukotrienes in asthma",
      "Montelukast blocks cysteinyl leukotriene receptor (CysLT1)",
      "Corticosteroids induce lipocortin (annexin-1) → inhibit PLA₂ → ↓ arachidonic acid release",
      "Snake venom PLA₂ — tissue necrosis and inflammation",
    ],
    boardsPearls: [
      "PLA₂ releases arachidonic acid from membrane phospholipids",
      "Arachidonic acid → COX → prostaglandins, thromboxane (NSAID target)",
      "Arachidonic acid → 5-LOX → leukotrienes (zileuton, montelukast)",
      "Corticosteroids ↓ PLA₂ activity via lipocortin — upstream of COX/LOX",
      "vs phospholipase C — cleaves PIP2 to IP3/DAG (Gq), not arachidonic acid",
      "Thromboxane A₂ (platelet aggregation) vs prostacyclin PGI₂ (vasodilation, anti-aggregate)",
      "Aspirin = irreversible COX inhibitor; other NSAIDs mostly reversible",
    ],
    distinguishFrom: [
      "Phospholipase C — cleaves PIP2 → IP3 + DAG (Gq second messengers), not eicosanoids",
      "Phospholipase A₂ vs C — different substrates and products; both are membrane lipid enzymes",
      "Prostaglandins — COX products downstream of arachidonic acid",
      "Leukotrienes — LOX products downstream of arachidonic acid",
      "Cyclooxygenase (COX) — enzyme acting on free arachidonic acid, not membrane release step",
      "Lipoxin — anti-inflammatory LOX metabolites, distinct from pro-inflammatory leukotrienes",
    ],
    pediatrics:
      "PGE₁ (alprostadil) keeps ductus arteriosus patent in ductal-dependent congenital heart disease — prostaglandin from arachidonic acid pathway. Aspirin avoided for fever in viral illness (Reye syndrome). Leukotriene modifiers used in pediatric asthma.",
  },
  {
    id: "jak2",
    name: "Janus Kinase 2",
    etymology:
      "Janus = Roman two-faced god + kinase = phosphorylating enzyme + 2 = second family member — non-receptor tyrosine kinase associated with cytokine and hormone receptors",
    aliases: [
      "jak2",
      "jak 2",
      "janus kinase 2",
    ...
    type: "Signaling pathway",
    source:
      "Cytoplasmic non-receptor tyrosine kinase constitutively associated with cytoplasmic tails of type I cytokine receptors (EPO, TPO, GM-CSF, GH) and some other hematopoietic receptors",
    receptor:
      "JAK2 pairs with JAK1 or TYK2 on cytokine receptor dimers — ligand binding induces receptor conformation → JAK transphosphorylation → STAT phosphorylation and nuclear translocation",
    function:
      "Ligand binds cytokine receptor → JAK2 autophosphorylates and phosphorylates receptor tails → recruits STAT proteins → STATs dimerize and translocate to nucleus → transcription of proliferation and survival genes (e.g., erythropoiesis after EPO).",
    clinicalRelevance: [
      "JAK2 V617F activating mutation — polycythemia vera (>95%), essential thrombocythemia, primary myelofibrosis",
      "Constitutive JAK2 activity → cytokine-independent hematopoietic proliferation",
      "Erythropoietin → EPO receptor → JAK2/STAT5 → red cell production (exogenous EPO therapy)",
      "JAK inhibitors (ruxolitinib) — treat myelofibrosis and polycythemia vera",
      "JAK2 exon 12 mutations — JAK2 V617F–negative polycythemia vera subset",
    ],
    boardsPearls: [
      "JAK2 = Janus kinase 2 — tyrosine kinase on cytokine receptor cytoplasmic tails",
      "JAK2 V617F — hallmark of polycythemia vera (low EPO, ↑ Hct, splenomegaly)",
      "JAK-STAT pathway — cytokine signal: receptor → JAK → STAT → gene transcription",
      "EPO receptor signals through JAK2/STAT5 → erythropoiesis",
      "vs BCR-ABL — tyrosine kinase in CML (Philadelphia chromosome), not JAK2",
      "vs receptor tyrosine kinase (EGFR, insulin) — autophosphorylates own receptor; JAKs associate with non-kinase cytokine receptors",
      "Ruxolitinib — JAK1/JAK2 inhibitor for myeloproliferative neoplasms",
    ],
    distinguishFrom: [
      "JAK1/JAK3 — other JAK family members paired with different cytokine receptors (IFN-γ uses JAK1/JAK2)",
      "STAT5 — transcription factor phosphorylated by JAK2, not the kinase itself",
      "BCR-ABL — fusion tyrosine kinase in CML; different pathway and drug (imatinib)",
      "Receptor tyrosine kinase — insulin, EGF receptors have intrinsic kinase domain",
      "Tyrosine kinase — broad class; JAK2 is non-receptor tyrosine kinase for cytokine receptors",
      "EPO — ligand for erythropoietin receptor; JAK2 is downstream signal transducer",
    ],
    pediatrics:
      "Polycythemia vera is primarily adult MPN; JAK2 V617F testing applies when adolescent presents with unexplained erythrocytosis. EPO used in pediatric chronic kidney disease anemia via same JAK2/STAT5 erythropoiesis pathway.",
  },
  {
    id: "phosphatidylinositol-ip3-pathway",
    name: "Phosphatidylinositol / Inositol Trisphosphate Pathway",
    etymology:
      "phosphatidyl = fatty acid diester + inositol = cyclic sugar alcohol + triphosphate = three phosphate groups — PIP₂ in membrane cleaved by PLC to IP₃ and DAG",
    aliases: [
      ...
      "phosphatidylinositol 4 5 bisphosphate",
      "phosphatidylinositol / inositol trisphosphate",
      "phosphatidylinositol inositol trisphosphate",
      "plc-ip3 pathway",
      "pip2-ip3 pathway",
    ...
    type: "Signaling pathway",
    source:
      "Phosphatidylinositol 4,5-bisphosphate (PIP₂) in inner leaflet of plasma membrane — substrate for phospholipase C (PLC) activated by Gq-coupled GPCRs and some receptor tyrosine kinases",
    receptor:
      "Gq GPCRs (α1-adrenergic, M1/M3 muscarinic, H1 histamine, V1 vasopressin, GnRH, angiotensin II AT1) → Gαq activates PLCβ → cleaves PIP₂",
    function:
      "PLC hydrolyzes PIP₂ → inositol 1,4,5-trisphosphate (IP₃) + diacylglycerol (DAG); IP₃ diffuses to ER → binds IP₃ receptor → Ca²⁺ release into cytosol; DAG activates PKC at membrane — parallel second-messenger arms from one phosphoinositide cleavage.",
    clinicalRelevance: [
      "Smooth muscle contraction — Gq → IP₃ → Ca²⁺ → MLCK (vascular, bronchial, GI)",
      "α1-blockers (prazosin) reduce Gq–PLC–IP₃ signaling in hypertension/BPH",
      "Exocrine secretion — pancreatic and salivary acinar cells use IP₃-mediated Ca²⁺ spikes",
      "Oxytocin and angiotensin II — Gq-coupled hormones using PIP₂/PLC/IP₃",
      "Lithium — may affect phosphoinositide cycle (inositol monophosphatase inhibition)",
    ],
    boardsPearls: [
      "PIP₂ (phosphatidylinositol 4,5-bisphosphate) → PLC → IP₃ + DAG",
      "IP₃ releases Ca²⁺ from ER stores via IP₃ receptor",
      "DAG activates protein kinase C (parallel arm — see dag-pkc-pathway)",
      "Gq GPCRs — M3, α1, H1, V1 use phosphatidylinositol/PLC pathway",
      "vs cAMP pathway — Gs uses adenylyl cyclase, not PIP₂ cleavage",
      "vs arachidonic acid — PLA₂ releases AA from phospholipids; PLC cleaves PIP₂ head group",
      "Ca²⁺–calmodulin–MLCK — smooth muscle contraction downstream of IP₃",
    ],
    distinguishFrom: [
      "DAG/PKC pathway — lipid arm from same PLC cleavage; IP₃ is soluble Ca²⁺-mobilizing arm",
      "cAMP/PKA pathway — Gs/Gi and adenylyl cyclase, not phosphoinositide",
      "Arachidonic acid/PLA₂ — eicosanoid precursor release, different phospholipase",
      "Ryanodine receptor — SR Ca²⁺ release in muscle; IP₃ receptor is on ER",
      "Phosphatidylinositol 3-kinase (PI3K) — phosphorylates PI to PIP₃ for Akt pathway, not PLC cleavage",
      "Calcium channel — voltage-gated membrane entry vs IP₃-mediated ER release",
    ],
    pediatrics:
      "Bronchoconstriction in asthma involves Gq–IP₃–Ca²⁺ in airway smooth muscle. Same phosphoinositide signaling in all ages; anticholinergics (ipratropium) block M3 → ↓ PLC activation.",
  },
  {
    id: "ras-mapk-pathway",
    name: "Ras / Mitogen-Activated Protein Kinase Pathway",
    etymology:
      "Ras = rat sarcoma viral oncogene + MAPK = mitogen-activated protein kinase — RTK→Ras→Raf→MEK→ERK kinase cascade transmitting growth factor signals to nucleus",
    aliases: [
      "ras",
      "ras protein",
      "ras/mapk pathway",
    ...
    type: "Signaling pathway",
    source:
      "Activated by growth factors (EGF, PDGF, insulin, IGF-1) binding receptor tyrosine kinases (RTKs) or some GPCRs — Ras-GTP recruited to membrane via GRB2–SOS adaptor complex after RTK autophosphorylation",
    receptor:
      "Receptor tyrosine kinases — EGF receptor, PDGF receptor, insulin receptor, RET; Ras is small GTPase switch (GTP = ON, GDP = OFF)",
    function:
      "Ligand → RTK dimerization and autophosphorylation → GRB2–SOS exchanges GDP for GTP on Ras → active Ras-GTP recruits Raf (MAPKKK) → phosphorylates MEK (MAPKK) → phosphorylates ERK (MAPK) → ERK translocates to nucleus → phosphorylates transcription factors (e.g., ELK-1) → cell proliferation, differentiation, and survival.",
    clinicalRelevance: [
      "RAS oncogene mutations (KRAS, NRAS, HRAS) — constitutively active GTP-bound Ras → uncontrolled proliferation (pancreatic, colorectal, melanoma, lung adenocarcinoma)",
      "BRAF V600E mutation — constitutively active Raf in melanoma and other cancers",
      "Neurofibromatosis type 1 — NF1 encodes Ras-GAP; loss → ↑ Ras activity → neurofibromas, café-au-lait spots",
      "Noonan syndrome — activating mutations in Ras pathway components (PTPN11/SHP2, SOS1, KRAS)",
      "BRAF and MEK inhibitors (vemurafenib, trametinib) — targeted therapy in BRAF-mutant melanoma",
      "Cardiac hypertrophy — chronic MAPK activation in pressure overload",
    ],
    boardsPearls: [
      "RTK → Ras → Raf → MEK → ERK — classic MAP kinase cascade",
      "Ras = small GTPase; GTP-bound = active; oncogenic mutations impair GTP hydrolysis",
      "NF1 = neurofibromin (Ras-GAP) — accelerates Ras GTP hydrolysis; NF1 loss → ↑ Ras signaling",
      "KRAS mutations — common in pancreatic and colorectal cancer; often mutually exclusive with EGFR inhibitor benefit in CRC",
      "BRAF V600E — melanoma target; BRAF inhibitors can cause secondary skin cancers (paradoxical MAPK activation)",
      "vs PI3K/Akt — parallel RTK branch for metabolism and survival, not same kinase cascade",
      "vs JAK-STAT — cytokine receptors use JAKs, not Ras-MAPK primarily",
      "MEK is dual-specificity kinase — phosphorylates both Tyr and Ser/Thr on ERK",
    ],
    distinguishFrom: [
      "PI3K/Akt/mTOR pathway — parallel RTK signaling for growth and metabolism",
      "JAK-STAT pathway — cytokine receptors; not Ras-dependent MAPK in classic form",
      "cAMP/PKA pathway — GPCR second messenger, not RTK-Ras cascade",
      "G protein (heterotrimeric) — different GTP-binding switch from monomeric Ras",
      "Raf — MAP kinase kinase kinase (MAPKKK) downstream of Ras",
      "ERK — extracellular signal-regulated kinase; terminal MAPK in classic cascade",
      "Oncogene — functional category; RAS is classic oncogene in this pathway",
    ],
    pediatrics:
      "Neurofibromatosis type 1 presents in childhood with café-au-lait macules, neurofibromas, and learning issues from NF1 (Ras-GAP) loss. Noonan syndrome causes short stature, pulmonic stenosis, and facial dysmorphism from Ras pathway gain-of-function. Same MAPK cascade logic across ages.",
  },
  {
    id: "endogenous-opioid",
    name: "Endogenous Opioid",
    etymology:
      "Greek endon = within + Latin opium = poppy juice + -oid = resembling — endogenous peptide neurotransmitters and hormones that activate opioid receptors to modulate pain, mood, and autonomic function",
    aliases: [
      "endogenous opioid",
      "endogenous opiate",
    ...
    type: "Neurotransmitter",
    source:
      "β-endorphin from proopiomelanocortin (POMC) in hypothalamus/pituitary; enkephalins (met/leu) and dynorphins from separate precursors in CNS neurons, adrenal medulla, and gut — released with nociceptive and stress stimuli",
    receptor:
      "μ (mu), δ (delta), and κ (kappa) opioid GPCRs — Gi/Go coupled → ↓ cAMP, ↓ Ca²⁺ influx, ↑ K⁺ efflux → hyperpolarization and ↓ neurotransmitter release",
    function:
      "Inhibit pain transmission in spinal cord and brainstem (gate control at substantia gelatinosa), produce analgesia and euphoria, modulate GI motility and respiratory drive, and dampen sympathetic outflow — physiologic counterpart to exogenous opioid drugs.",
    clinicalRelevance: [
      "Exercise-induced euphoria ('runner's high') — partly endogenous opioid release",
      "Spinal opioid receptors targeted by intrathecal morphine in severe pain",
      "Naloxone reverses both exogenous opioids and endogenous opioid effects in overdose",
      "Stress and pain activate POMC → ACTH and β-endorphin co-release",
      "Opioid tolerance and dependence involve receptor desensitization and downregulation",
    ],
    boardsPearls: [
      "Endogenous opioids — β-endorphin, enkephalins, dynorphins",
      "β-endorphin from POMC (same precursor as ACTH and MSH)",
      "μ receptor — primary analgesia; exogenous morphine/fentanyl agonists",
      "Spinal enkephalinergic interneurons inhibit substance P release — pain gate",
      "Naloxone — opioid receptor antagonist reverses toxidrome",
      "vs exogenous opioids — morphine/heroin are drugs; endorphins are native peptides",
      "κ agonism — dysphoria/sedation; μ agonism — analgesia and respiratory depression",
    ],
    distinguishFrom: [
      "Exogenous opioids — morphine, fentanyl, heroin; drug class not endogenous peptides",
      "Substance P — tachykinin pain transmitter; blocked at NK1 not opioid receptor",
      "Endocannabinoids — lipid mediators modulating pain separately from opioid system",
      "GABA — inhibitory amino acid neurotransmitter, not opioid peptide",
      "ACTH — co-derived from POMC but regulates cortisol, not opioid receptor",
    ],
    pediatrics:
      "Neonatal abstinence syndrome from maternal opioid use reflects fetal μ-receptor dependence on exogenous opioids, not endogenous peptides. Endogenous β-endorphin participates in stress response in infants; naloxone can precipitate withdrawal in opioid-exposed neonates.",
  },
  {
    id: "neurokinin-1-receptor",
    name: "Neurokinin 1 Receptor",
    etymology:
      "neuro- = nerve + Latin kinin = movement + 1 = first subtype + receptor = receiver — G protein–coupled receptor preferentially activated by substance P (tachykinin) in pain, emesis, and neurogenic inflammation",
    aliases: [
      "neurokinin 1",
    ...
    type: "Neurotransmitter",
    source:
      "Expressed on neurons in dorsal horn, brainstem emesis centers (area postrema, NTS), enteric nervous system, and peripheral inflammatory cells — activated by substance P released from sensory C-fibers",
    receptor:
      "GPCR (NK1R) coupled to Gq → PLC → IP₃/DAG → Ca²⁺ release and PKC activation",
    function:
      "Mediates nociceptive signaling, neurogenic inflammation (vasodilation, plasma extravasation), and emesis — central NK1 activation in chemoreceptor trigger zone and vomiting center drives delayed chemotherapy-induced nausea and vomiting.",
    clinicalRelevance: [
      "NK1 receptor antagonists (aprepitant, fosaprepitant) prevent delayed chemotherapy-induced nausea and vomiting",
      "Substance P / NK1 pathway in migraine and chronic pain sensitization",
      "Capsaicin depletes substance P from nociceptors, indirectly reducing NK1 activation",
      "NK1 antagonists combined with 5-HT₃ antagonists and dexamethasone for antiemetic triplet regimens",
    ],
    boardsPearls: [
      "Neurokinin 1 (NK1) receptor — primary receptor for substance P",
      "NK1 antagonists (aprepitant) — antiemetic for chemotherapy nausea (delayed phase)",
      "Substance P from sensory neurons → NK1 → pain and neurogenic inflammation",
      "vs 5-HT₃ receptor — ondansetron target for acute CINV; NK1 for delayed phase",
      "vs opioid receptors — separate analgesic pathway; naloxone does not block NK1",
      "Tachykinin family — substance P (NK1), neurokinin A (NK2), neurokinin B (NK3)",
    ],
    distinguishFrom: [
      "Substance P — peptide ligand, not the receptor",
      "Neurokinin 2/3 receptors — prefer neurokinin A/B; different tachykinin selectivity",
      "5-HT₃ receptor — serotonin ion channel in acute emesis; different antiemetic drug target",
      "Opioid μ receptor — endogenous opioid and morphine analgesia pathway",
      "Histamine H₁ receptor — allergy and vestibular nausea, not substance P pathway",
    ],
    pediatrics:
      "Aprepitant used at weight-based dosing for pediatric chemotherapy-induced nausea. Substance P/NK1 nociceptive biology is the same in children; NK1 antagonists do not replace opioid analgesia for severe pain.",
  },
  {
    id: "neuropeptide-y",
    name: "Neuropeptide Y",
    etymology:
      "neuro- = nerve + peptide = amino acid chain + Y = tyrosine-rich N-terminal — 36-amino-acid neuropeptide homologous to pancreatic polypeptide family regulating appetite, sympathetic tone, and vascular tone",
    aliases: [
      "neuropeptide y",
      "npy",
      "neuropeptide-y",
      "neuropeptide y peptide",
    ],
    type: "Neurotransmitter",
    source:
      "Synthesized in hypothalamic arcuate nucleus (with AgRP neurons), sympathetic ganglia, adrenal medulla, and enteric neurons — co-released with norepinephrine from sympathetic nerve terminals",
    receptor:
      "Y1, Y2, Y4, Y5 GPCRs (Gi-coupled) — Y1 and Y5 stimulate feeding; Y2 presynaptic autoreceptor inhibits further NPY release",
    function:
      "Potent orexigenic signal stimulating food intake, reduces energy expenditure, promotes vasoconstriction and modulates anxiety/seizure threshold — counter-regulates anorexigenic α-MSH/leptin pathways in hypothalamic energy balance.",
    clinicalRelevance: [
      "↑ NPY/AgRP arcuate neuron activity drives hunger — opposite of POMC/CART anorexigenic neurons",
      "Sympathetic co-transmission — NPY with NE causes sustained vasoconstriction",
      "Seizure protection and anxiolytic effects at some central Y receptors (research context)",
      "Obesity research — chronic hyperleptinemia may fail to suppress NPY (leptin resistance)",
    ],
    boardsPearls: [
      "Neuropeptide Y (NPY) — orexigenic hypothalamic peptide; stimulates appetite",
      "Arcuate nucleus — NPY/AgRP neurons (hunger) vs POMC/CART (satiety)",
      "Co-released with norepinephrine from sympathetic neurons → vasoconstriction",
      "vs leptin — anorexigenic adipokine inhibiting NPY neurons",
      "vs ghrelin — stomach-derived hunger hormone; both increase appetite via hypothalamus",
      "Pancreatic polypeptide family — NPY, PYY, PP share structural homology",
    ],
    distinguishFrom: [
      "Peptide YY (PYY) — gut hormone released postprandially to reduce appetite (anorexigenic)",
      "Pancreatic polypeptide (PP) — islet/gut peptide; related family member",
      "AgRP — orexigenic neuropeptide co-expressed with NPY in arcuate neurons",
      "α-MSH — anorexigenic POMC product opposing NPY",
      "Substance P — tachykinin pain/emesis peptide, not appetite regulator",
    ],
    pediatrics:
      "Hypothalamic appetite circuits mature in infancy; failure to thrive and obesity both involve energy-balance neuropeptide signaling. Prader-Willi syndrome causes hyperphagia through hypothalamic dysregulation including NPY pathway hyperactivity.",
  },
  {
    id: "nicotinic-acetylcholine-receptor",
    name: "Nicotinic Acetylcholine Receptor",
    etymology:
      "Latin nicotiana = tobacco plant + acetyl + Greek chole + receptor — ligand-gated cation channel activated by acetylcholine at neuromuscular junction and autonomic ganglia (named for nicotine agonism)",
    aliases: [
    ...
    type: "Neurotransmitter",
    source:
      "Postsynaptic membrane of skeletal muscle motor end plate (Nm subtype) and postganglionic neurons in autonomic ganglia plus adrenal medulla chromaffin cells (Nn subtype) — pentameric transmembrane ion channel",
    receptor:
      "Ligand-gated nonselective cation channel (Na⁺/K⁺/Ca²⁺) — ACh binding causes depolarization; blocked by nondepolarizing neuromuscular blockers (rocuronium, vecuronium) or persistently activated by succinylcholine",
    function:
      "Mediates fast excitatory synaptic transmission at neuromuscular junction (skeletal muscle contraction) and autonomic ganglia (preganglionic → postganglionic signaling); distinct from slower muscarinic GPCR effects of ACh on target organs.",
    clinicalRelevance: [
      "Myasthenia gravis — autoantibodies destroy nicotinic ACh receptors at NMJ → fatigable weakness",
      "Neonatal myasthenia — transplacental anti-AChR antibodies",
      "Organophosphate poisoning — excess ACh causes nicotinic fasciculations, weakness, paralysis",
      "Neuromuscular blockers — nondepolarizing (competitive) and depolarizing (succinylcholine) act at nicotinic NMJ receptor",
      "Nicotine — exogenous agonist at ganglionic and CNS nicotinic receptors (addiction, ↑ BP)",
      "Curare derivatives — competitive nicotinic antagonists at NMJ",
    ],
    boardsPearls: [
      "Nicotinic ACh receptor = ligand-gated ion channel (ionotropic)",
      "Nm at neuromuscular junction; Nn at autonomic ganglia",
      "vs muscarinic — GPCR; sweat glands and target organs postganglionic parasympathetic",
      "Myasthenia gravis — antibodies to nicotinic receptor at NMJ",
      "Succinylcholine — depolarizing NMJ blocker; rocuronium — nondepolarizing competitive block",
      "Preganglionic autonomic fibers always release ACh onto nicotinic receptors",
      "Atropine blocks muscarinic only — does not reverse nicotinic paralysis (use pralidoxime for organophosphates)",
    ],
    distinguishFrom: [
      "Muscarinic acetylcholine receptor — GPCR (M1–M5); organ effectors not NMJ",
      "Acetylcholine — neurotransmitter ligand, not the receptor protein",
      "Acetylcholinesterase — degrades ACh in synaptic cleft",
      "GABA-A receptor — ligand-gated chloride channel inhibitory in CNS",
      "Nicotinic acid — niacin (vitamin B₃), unrelated to ACh receptor despite name overlap",
    ],
    pediatrics:
