...
import autonomicSymptoms from "../media/images/symptoms/autonomic-symptoms.png?url";
...
import brudzinskiSign from "../media/images/symptoms/brudzinski-sign.jpg?url";
...
> = {
  ...
  "amnesia": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:amnesia.jpg" },
  "androgenic-alopecia": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:androgenic-alopecia.png" },
  "ankle-reflex": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:ankle-reflex.jpg" },
  "anosmia": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:anosmia.png" },
  ...
  "autonomic-symptoms": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:autonomic-symptoms.png" },
  ...
  "brain-fog": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:brain-fog.jpg" },
  "brudzinski-sign": { label: "Wikimedia Commons (Brud I.png)", url: "https://commons.wikimedia.org/wiki/File:Brud_I.png" },
  ...
  "cannon-a-waves": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:cannon-a-waves.jpg" },
  "cataplexy": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:cataplexy.png" },
  "central-adiposity": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:central-adiposity.svg" },
  "central-nervous-system-depression": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:central-nervous-system-depression.png" },
  ...
  "cheyne-stokes-respiration": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:cheyne-stokes-respiration.svg" },
  ...
  "confusion": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:confusion.jpg" },
  ...
  "decerebrate-posturing": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:decerebrate-posturing.jpg" },
  "decorticate-posturing": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:decorticate-posturing.jpg" },
  ...
  "hirsutism": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:hirsutism.png" },
  "hyperactive-bowel-sounds": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:hyperactive-bowel-sounds.jpg" },
  "hypercapnia": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:hypercapnia.svg" },
  ...
  "lacrimation": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:lacrimation.jpg" },
  ...
  "periorbital-pain": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:periorbital-pain.svg" },
  ...
  "pinpoint-pupils": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:pinpoint-pupils.png" },
  ...
  "polydipsia": { label: "Wikimedia Commons (Glass of water with ice cubes.JPG)", url: "https://commons.wikimedia.org/wiki/File:Glass_of_water_with_ice_cubes.JPG" },
  ...
  "ptosis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:ptosis.jpg" },
  ...
  "sleep-paralysis": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:sleep-paralysis.jpg" },
  ...
  "vertigo": { label: "Wikimedia Commons (Semont maneuver hariadhi.svg)", url: "https://commons.wikimedia.org/wiki/File:Semont_maneuver_hariadhi.svg" },
  ...
  "virilization": { label: "Wikimedia Commons", url: "https://commons.wikimedia.org/wiki/File:virilization.jpg" },
